...
/**
 * A Dispersal implementation which does nothing (effectively 'off').
 */
public class DispersalOff implements Dispersal {

	private static final int DISPERSAL_ID = 0;
	private static final String DISPERSAL_SHORT_NAME = "OFF";
