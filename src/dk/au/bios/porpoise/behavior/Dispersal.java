...
public interface Dispersal {
	...
	/**
	 * Get the unique short name identifying this dispersal behaviour.
	 * 
	 * @return The unique short name identifying this dispersal behaviour.
	 */
	String getDispersalShortName();
	...
	/**
	 * Get the target (or source) NdPoint for the dispersal.
	 *
	 * @return The target (or source) NdPoint for the dispersal.
	 */
	NdPoint getTargetPosition();

	double getTargetHeading();

	double getDistanceLeftToTravel();

	boolean calfHasPSM();

	boolean calfInheritsPsmDist();
