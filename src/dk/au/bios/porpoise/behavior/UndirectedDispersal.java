...
public class UndirectedDispersal extends DispersalPSMType3 implements Dispersal {

	private static final int DISPERSAL_ID = 5;
	private static final String DISPERSAL_SHORT_NAME = "UNDIR";

	public UndirectedDispersal(final Porpoise owner) {
		super(owner);
	}
	...
	/**
	 * Always returns -1 to trigger random selection of target cell within the preferred distance and band.
	 */
	@Override
	...
	/**
	 * A copy of the PSM-Type2 calculation, which was previously in the AbstractPSMDispersal. TODO Is this correct for
	 * this behaviour?
	 */
	@Override
