 ...
 */
public class ReplayedSimulationDanTyskTest extends AbstractReplayedSimulationTest {

	@SystemTest
	@DisplayName("DanTysk, Dispersal Off, Turbines, 10 Porpoises")
	void dispOffWithTurbines() throws Exception {
		simulation("test/dk/au/bios/porpoise/testdata_DanTysk_DispOff_Turbines_10porp.txt");
	}

	@SystemTest
	@DisplayName("DanTysk, Dispersal Undirected, Turbines Off, 10 Porpoises")
	void dispUndirectedNoTurbines() throws Exception {
		simulation("test/dk/au/bios/porpoise/testdata_DanTysk_Undirected_NoTurbines_10porp.txt");
	}

	@SystemTest
	@DisplayName("DanTysk, Dispersal PSM-Type2, Turbines Off, 10 Porpoises")
	void dispPSM2NoTurbines() throws Exception {
