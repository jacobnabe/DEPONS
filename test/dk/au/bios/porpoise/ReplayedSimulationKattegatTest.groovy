 ...
 */
class ReplayedSimulationKattegatTest extends AbstractReplayedSimulationTest {

	@Test
	void "Kattegat, Dispersal Off, No Turbines, 1 Porpoises"() {
		simulation("test/dk/au/bios/porpoise/testdata_Kattegat_DispOff_NoTurbines_1porp.txt");
	}

	@Test
	void "Kattegat, Dispersal Undirected, No Turbines, 1 Porpoises"() {
		simulation("test/dk/au/bios/porpoise/testdata_Kattegat_Undirected_NoTurbines_1porp.txt");
	}

	@Test
	void "Kattegat, Dispersal InnerDanishWaters, No Turbines, 1 Porpoises"() {
